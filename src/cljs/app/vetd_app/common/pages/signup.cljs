...
;; after a successful signup, the email they signed up with is stored here
(rf/reg-sub
       ...
       (if (nil? @terminal-success-email&)
         ...
         [:<>
          [:> ui/Message {:positive true
                          :header "Check your email inbox to complete signup!"
                          :content (str "We've sent an email to " @terminal-success-email& " with a link to activate your account.")
